...
const ImageDrawer: React.FC<Props> = ({ data, selectedCategory, imageList }) => {      
    console.log('render image drawer')
    ...
    const selectImage = useCallback((event: React.MouseEvent<HTMLButtonElement>): void => {
        const target = event.target as HTMLButtonElement
        const currentSelectedImage = document.querySelector('.' + styles.selectedImage)
    ...
    const handleSearchImage = useCallback((event: React.FormEvent<HTMLInputElement>): void => {
        console.log('handleSearchImage')
        ...
        <div className={styles.imageDrawer}>
            ...
            <div className={styles.search}>
                <div className={styles.searchInput}>
                    <input id="search-input" type="text" placeholder='Search for Photo...' onInput={handleSearchImage}></input>
                    <label htmlFor="search-input"><img src="Search.svg"></img></label>
                </div>
            </div>
